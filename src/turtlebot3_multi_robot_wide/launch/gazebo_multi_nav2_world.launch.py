...
def generate_launch_description():
    ...
    package_dir = get_package_share_directory('turtlebot3_multi_robot_wide')
    ...
    world = os.path.join(
        get_package_share_directory('turtlebot3_multi_robot_wide'),
        'worlds', 'wide_road_square.world')
